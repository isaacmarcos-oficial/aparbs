...
export function LinkIcons() {
  return (
    <Flex align="center"  gap="16px" display={{ base: "none", md: "flex" }} >
      <a href="tel:+5538991060376" target="_blank">
        <Icon as={FaPhoneAlt} boxSize="20.8px" _hover={{ color: "primary" }} cursor="pointer" />
      </a>
      <a href="https://api.whatsapp.com/send?phone=55383220-8767&text=Ol%C3%A1%2C%20estou%20no%20site%20da%20APARBS.%20Gostaria%20de%20receber%20atendimento" target="_blank" >
