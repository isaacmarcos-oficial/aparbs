...
export function Hero() {
  return (
    <Flex direction="column"  w="100%" >
      <Flex bgColor="#000000b9" h={{ base:"500px", lg:"600px" }} w="100%" align="end" justify="center" bgImage="/AparbsFront.jpg" bgSize="cover" bgBlendMode="overlay" bgPosition={{base:"90% 40%", lg:"50% 40%"}} >
